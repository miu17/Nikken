...
#include <QtGui>
namespace post3dapp{
SectionBeamLineDraw::SectionBeamLineDraw(const SectionDataType &type, QWidget *parent)
    :SectionLineDraw(type, parent)
{

}

void SectionBeamLineDraw::paintEvent( QPaintEvent * )
{
...
void SectionBeamLineDraw::drawOuterFrame(QPainter *pt)
{
    int hh = height();
    int ww = width();
