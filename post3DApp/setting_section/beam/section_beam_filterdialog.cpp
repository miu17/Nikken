...
namespace post3dapp{
SectionBeamFilterDialog::SectionBeamFilterDialog(const QList<SectionTableWidget *>& tabelWidgets, QWidget * parent)
    :SectionFilterDialog(tabelWidgets, parent)
{
    setWindowTitle(u8"表示設定　小梁");
    createLayout();
}

QVBoxLayout* SectionBeamFilterDialog::createSwitchLayout()
{
