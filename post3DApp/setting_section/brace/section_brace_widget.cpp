...
namespace post3dapp{
SectionBraceWidget::SectionBraceWidget( const SectionDataType &type, QWidget *parent )
    : SectionTableWidget( type, parent )
{
}

void SectionBraceWidget::createModels(){
    myTableModel = new SectionBraceTableModel(mySectionType, this);
    SectionTableWidget::createModels();
}

void SectionBraceWidget::createViews()
{
...
void SectionBraceWidget::createWidgets()
{
    ...
    lineButtons = new SectionBraceLineButtons(mySectionType, filter_columns, tab_input);
    ...
    lineDraw = new SectionBraceLineDraw(mySectionType, this);
