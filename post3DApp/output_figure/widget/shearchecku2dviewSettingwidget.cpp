...
OutputFigureShearCheckU2DWidget::OutputFigureShearCheckU2DWidget(const QString& tabName, const QString& englishTabName, QWidget *parent)
...
void OutputFigureShearCheckU2DWidget::initializeSettings(){
...
void OutputFigureShearCheckU2DWidget::writeBinaryFile(QDataStream &outfile) const{
...
void OutputFigureShearCheckU2DWidget::readBinaryFile(QDataStream &infile, const AppVersion &version){
...
void OutputFigureShearCheckU2DWidget::saveSettings(QSettings& settings){
...
void OutputFigureShearCheckU2DWidget::readSettings(QSettings& settings){
