#ifndef WALLEVENTOPERATION_H
#define WALLEVENTOPERATION_H
...
namespace post3dapp{
enum TARGETACTION;
class ManageWallActions;

class WallEventOperation : public AbstractEventOperation
{
    Q_OBJECT

public:

    WallEventOperation(CustomDrawGrView *view);
...
private:
    ...
    ManageWallActions *manageActions;
