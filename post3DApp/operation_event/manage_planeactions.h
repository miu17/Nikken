#ifndef MANAGEPLANEACTIONS_H
#define MANAGEPLANEACTIONS_H
...
class ManagePlaneActions : public QObject
{
    Q_OBJECT

public:

    ManagePlaneActions(PlaneEventOperation *parent);
...
protected:
    ...
    PlaneEventOperation *planeOperation;
