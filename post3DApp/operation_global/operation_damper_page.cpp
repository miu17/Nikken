...
namespace post3dapp{
OperationDamperPage::OperationDamperPage( QWidget *parent )
    : AbstractElementPage( parent )
{
    myElementType = ELDAMPER;

    ReferenceCombobox *fugo_combo = new ReferenceCombobox(DATATYPE::TPDAMPER, UnifiedDataType::Input, this);
...
void OperationDamperPage::slotChangeAddEditLayout(int id)
{
