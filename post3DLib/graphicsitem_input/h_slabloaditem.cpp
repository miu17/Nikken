...
namespace post3dapp{
SlabLoadHPlaneItem::SlabLoadHPlaneItem(const Input2DViewSettings& setting,const QList<QPointF> &plist,
                                        const QString &str, bool onplane)
    : CustomDrawHPlaneItem(setting,ELSLABLOAD, plist, str, onplane, 0.0)
{
    createShapePath();
    update(boundRect);
}

void SlabLoadHPlaneItem::createShapePath()
{
