#ifndef AXIALELEVATIONTEMPLATE_H
#define AXIALELEVATIONTEMPLATE_H
#include <QtMath>
...
class OutputGrScene;
class AxialElevationTemplate :public FigureCommonTemplateElevation
{
    Q_OBJECT

public:
    AxialElevationTemplate(const Analysis2DViewSettings&, const FIGURE_TYPE_PROPERTY&, QUuid);
