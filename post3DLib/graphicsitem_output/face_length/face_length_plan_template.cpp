...
FaceLengthPlanTemplate::FaceLengthPlanTemplate(const Analysis2DViewSettings& _setting, const FIGURE_TYPE_PROPERTY& type, QUuid id)
    : FigureCommonTemplatePlan(_setting, type, id)
{
}
void FaceLengthPlanTemplate::createLineItem(OutputGrScene* scene, MemberData *md, QList<QPointF> points)
{
    qDebug() << "makeLineItem";
