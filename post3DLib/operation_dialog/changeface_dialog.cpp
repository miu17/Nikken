...
void ChangeFaceDialog::createLayout()
{
    ...
    connect(ifaceRuleGroup, SIGNAL(buttonClicked(int)), this, SLOT(enableIFaceLineEdit(int)));
    ...
    connect(jfaceRuleGroup, SIGNAL(buttonClicked(int)), this, SLOT(enableJFaceLineEdit(int)));
