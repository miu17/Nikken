...
#include "vhline.h"
namespace post3dapp{
FindItemDialog::FindItemDialog( DATATYPE dtype, QWidget *parent,bool isout )
...
void FindItemDialog::createLayout()
{
    ...
    connect( jno_check, SIGNAL(toggled(bool)), jno_line1, SLOT(setEnabled(bool)) );
    connect( jno_check, SIGNAL(toggled(bool)), jno_line2, SLOT(setEnabled(bool)) );
    connect( jno_check, SIGNAL(toggled(bool)), jno_label, SLOT(setEnabled(bool)) );
    ...
    connect( jfl_check, SIGNAL(toggled(bool)), jfl_line, SLOT(setEnabled(bool)) );
    ...
    connect( jfr_check, SIGNAL(toggled(bool)), jfr_line, SLOT(setEnabled(bool)) );
    ...
    mtp_comb->setStyle( FactoryUnifiedData::getInstance(isOutput)->getWindowXPStyle() );
    ...
    connect( mtp_check, SIGNAL(toggled(bool)), mtp_comb, SLOT(setEnabled(bool)) );
    ...
    connect( mst_check, SIGNAL(toggled(bool)), mst_line, SLOT(setEnabled(bool)) );
    connect( mst_check, SIGNAL(toggled(bool)), mst_all,  SLOT(setEnabled(bool)) );
    connect( mst_check, SIGNAL(toggled(bool)), mst_part, SLOT(setEnabled(bool)) );
    ...
    connect( mfl_check, SIGNAL(toggled(bool)), mfl_line, SLOT(setEnabled(bool)) );
    connect( mfl_check, SIGNAL(toggled(bool)), mfl_all, SLOT(setEnabled(bool)) );
    connect( mfl_check, SIGNAL(toggled(bool)), mfl_part, SLOT(setEnabled(bool)) );
    ...
    connect( mfr_check, SIGNAL(toggled(bool)), mfr_line, SLOT(setEnabled(bool)) );
    connect( mfr_check, SIGNAL(toggled(bool)), mfr_all,  SLOT(setEnabled(bool)) );
    connect( mfr_check, SIGNAL(toggled(bool)), mfr_part, SLOT(setEnabled(bool)) );
