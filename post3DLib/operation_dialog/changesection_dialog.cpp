...
namespace post3dapp{
ChangeSectionDialog::ChangeSectionDialog(QWidget *parent,bool isout)
    : QDialog(parent)
{
    isOutput = isout;
...
void ChangeSectionDialog::createLayout()
{
    ...
    connect( elementComboBox, SIGNAL( currentIndexChanged(int) ),
             this, SLOT( slotChangeSectionComboBox(int) ) );
